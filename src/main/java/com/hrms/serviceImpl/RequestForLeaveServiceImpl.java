...
public class RequestForLeaveServiceImpl implements IRequestForLeaveService {
	...
	/*
	 * @Override public LeaveManagementOptionsResponseBean leaveManagementOptions()
	 * {
	 * 
	 ...
	 * leaveManagementRepository.listOfLeaveManagementOptions();
	 * 
	 * LeaveManagementOptionsResponseBean response = new
	 * LeaveManagementOptionsResponseBean();
	 * 
	 ...
	 * else { response.setMessage("No Leave Management Options are available.");
	 * response.setStatus(false);
	 * response.setListOfLeaveManagementOptions(listOfLeaveManagementOptions); }
	 * return response;
	 * 
