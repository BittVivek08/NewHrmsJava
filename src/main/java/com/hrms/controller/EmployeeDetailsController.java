...
public class EmployeeDetailsController {
	...
	/*
	 * @PostMapping("/saveEmployee") public EntityBeanResponse
	 * saveEmpDetails(@RequestBody EmployeeDetails empDetails,@RequestParam("file")
	 * MultipartFile file, @RequestParam("fileName") String fileName) throws
	 * IOException{
	 * 
	 * empDetails.setImage(file.getBytes().toString()); return
	 * empService.saveEmpDetails(empDetails);
	 * 
	 * }
	 */
	...
	public Contactbean saveDepartmentDetails(@RequestBody ContactDetails contactdata) {
		Contactbean saveContactDetails = this.empService.saveContactDetails(contactdata);
		return saveContactDetails;	
}
	
	@GetMapping("/getContactDetails")
    public ResponseEntity<List<ContactDetails>> getDepartmentDetails() {
        List<ContactDetails> contact = empService.getAllContactDetails();
        if (contact.isEmpty()) {
	 ...
	 public ResponseEntity<ContactDetails> updateDetails(@RequestBody ContactDetails contact) {
	      
		 ContactDetails updatecontact =empService.updateContactDetails(contact);
