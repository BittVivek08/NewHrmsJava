...
public class RequestForLeaveController {
	...
	public EmployeeLeaveTypeResponseBean saveEmployeeLeave(@RequestBody EmployeeLeaveTypeBean bean) {
	  ...
	  @GetMapping("/LeaveService") public LeaveManagementOptionsResponseBean
	...
	public MailStatusResponse updateLeaveReqOfEmp(@RequestBody UpdateEmployeeLeaveDetails bean,
	...
	public List<MyLeaveRequestEntity> getLeaveHistoryByConditions(@QueryParam(value = "formDate") int year,
			@QueryParam(value = "formDate") int month, @QueryParam(value = "leaveStatus") String status) {
